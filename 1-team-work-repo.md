...
[6] ระบบแจ้งให้ผู้ทำ PR ทราบว่าไม่มีข้อขัดแย้ง สามารถรวมงานเข้ากับ upstream repo ได้ ซึ่งการจะไดเรวมหรือไม่ ขึ้นอยู่กับเจ้าของ upstream repo (ซึ่งก็คือหัวหน้าทีม)
