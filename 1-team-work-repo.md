...
[4] ระบบแจ้งให้ผู้ทำ PR ทราบว่าไม่มีข้อขัดแย้ง สามารถรวมงานเข้ากับ upstream repo ได้ ซึ่งการจะไดเรวมหรือไม่ ขึ้นอยู่กับเจ้าของ upstream repo (ซึ่งก็คือหัวหน้าทีม)

2.11 ให้หัวหน้าทีมตรวจสอบและทำการ merge pull request ให้เรียบร้อย

หัวหน้าทีมจะเห็นว่ามีการทำ pull request เข้ามาและมีตำนวนเท่าใด
